...
const provider = new HttpProvider(process.env.HTTP_RPC_ENDPOINT || 'http://localhost:9033')
...
async function main() {
  ...
  execSync(binaryPath + ' build-spec --chain ./customSpecRaw.json --raw > ' + forkedSpecPath);
